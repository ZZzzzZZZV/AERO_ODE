...
Modified [NeuralGCM](https://github.com/neuralgcm/neuralgcm) source is included under
[Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0). See `AERO_ODE/AERO_Surface/neuralgcm-main/LICENSE` and `AERO_ODE/AERO_AIR/neuralgcm-main/LICENSE`.

NeuralGCM pretrained weights (if distributed) are under [CC-BY-SA-4.0](https://creativecommons.org/licenses/by-sa/4.0/).

[Dinosaur](https://github.com/neuralgcm/dinosaur) — Apache-2.0 (if included).
