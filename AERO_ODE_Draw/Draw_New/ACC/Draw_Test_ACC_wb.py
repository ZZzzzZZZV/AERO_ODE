...
acc_lam_48 = np.load(str(repo("Wb_ACC/Aero_ODE_acc.npy")))[0:48, ...]
acc_lam_72 = np.load(str(repo("Wb_ACC/Aero_ODE_acc.npy")))

acc_ngcm_72 = np.load(str(repo("Wb_ACC/neuralgcm_acc.npy")))[:, :20, ...]

acc_pangu_72 = np.load(str(repo("Wb_ACC/pangu_acc.npy")))

acc_yl_48 = np.load(str(repo("Wb_ACC/YingLong_nwp_acc.npy")))[:, :24]
acc_nwp_48 = np.load(str(repo("Wb_ACC/nwp_acc.npy")))

acc_ifs_72 = np.load(str(repo("Wb_ACC/ifs_acc.npy")))
...
if __name__ == "__main__":
    ...
    plot_acc_combined(
        ...
        save_base="figures_wb/acc_48_wb",
        show=False,
    )
    ...
    plot_acc_combined(
        ...
        save_base="figures_wb/acc_72_wb",
        show=False,
    )
