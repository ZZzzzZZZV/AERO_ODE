"""
West (Wb) RMSE curves: upper-air + surface combined in one 6x4 figure.

Run: python Draw_Test_RMER_wb.py
"""
...
rmse_Aero_ODE_48 = np.load(str(repo("Wb_RMSE/Aero_ODE_rmse.npy")))[0:48, ...]
rmse_Aero_ODE_72 = np.load(str(repo("Wb_RMSE/Aero_ODE_rmse.npy")))[0:72, ...]

rmse_NeuralGCM_48 = np.load(str(repo("Wb_RMSE/neuralgcm_rmse.npy")))[0:48, :20, ...]
rmse_NeuralGCM_72 = np.load(str(repo("Wb_RMSE/neuralgcm_rmse.npy")))[0:72, :20, ...]

rmse_PanGu_48 = np.load(str(repo("Wb_RMSE/pangu_rmse.npy")))[:48, ...]
rmse_PanGu_72 = np.load(str(repo("Wb_RMSE/pangu_rmse.npy")))[:72, ...]

# West YingLong-WRF: shape (48, 24), same layout as nwp_rmse
rmse_yl_bc_nwp_48 = np.load(str(repo("Wb_RMSE/YingLong_nwp_rmse.npy")))[:, :24]
rmse_nwp_48 = np.load(str(repo("Wb_RMSE/nwp_rmse.npy")))

rmse_IFS_72 = np.load(str(repo("Wb_RMSE/ifs_rmse.npy")))[:72, ...]
...
if __name__ == "__main__":
    ...
    plot_rmse_combined(
        ...
        save_base="figures_wb/rmse_48_wb",
        show=False,
    )
    ...
    plot_rmse_combined(
        ...
        save_base="figures_wb/rmse_72_wb",
        show=False,
    )
