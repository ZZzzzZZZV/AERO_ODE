"""
AERO-Surface surface static feature batch generator
...
def process_landcover_geotiff(tiff_path, hrrr_lats, hrrr_lons):
    ...
    with rasterio.open(tiff_path) as src:
        ...
        # Regrid to HRRR mesh
        print("  Regrid to target mesh...")
        points = np.stack([hrrr_lats.ravel(), hrrr_lons.ravel()], axis=-1)
...
def main():
    parser = argparse.ArgumentParser(
        description='Generate all AERO-Surface surface static features',
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Input files:
  geo.h5                    DEM elevation (HDF5, dataset 'fields')
  MODIS_LandCover_HRRR.tif  MODIS land cover (GeoTIFF)
  lats.npy                  Latitude grid
  lons.npy                  Longitude grid
...
Examples:
  ...
  python generate_all_static_features.py --input_dir ./data --output_dir ./data
    ...
    parser.add_argument('--geo_file', type=str, default='geo.h5',
                        help='DEM filename (default: geo.h5)')
    parser.add_argument('--landcover_file', type=str, default='MODIS_LandCover_HRRR.tif',
                        help='MODIS land-cover filename (default: MODIS_LandCover_HRRR.tif)')
    parser.add_argument('--lats_file', type=str, default='lats.npy',
                        help='Latitude filename (default: lats.npy)')
    parser.add_argument('--lons_file', type=str, default='lons.npy',
    ...
    print("=" * 70)
    print("AERO-Surface static feature generator")
    print("=" * 70)
